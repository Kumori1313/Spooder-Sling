...
Open the `.sln` in your IDE to get full IntelliSense and debugging support. This file is regenerated by Unity and are excluded from version control by `ignore.conf`.
